...
open class RefreshTextLottieFooter: RefreshFooter {
    ...
    open var lottieProvider: RefreshLottieContentProvider = .init()
    ...
    open override var state: RefreshState {
        didSet {
            ...
            lottieProvider.render(state: state, refresh: self)
            setNeedsUpdate()
        }
    }
    ...
    open override func initSetups() {
        ...
        lottieProvider.initSetups(refresh: self)
    }
    ...
    open override func updateConstraints() {
        ...
        lottieProvider.updateConstraints(refresh: self)
    ...
    open override func layoutSubviews() {
        ...
        lottieProvider.layoutSubviews(refresh: self)
    }
    ...
    // MARK: Indicator
    open func set(animation: RefreshLottieProvider.AnimateInfo) {
        lottieProvider.set(animation: animation)
    }
    
    open func set(configs: @escaping RefreshLottieProvider.StateInfo.Configs, for state: OptionRefreshState) {
        lottieProvider.set(configs: configs, for: state)
    }
    ...
    open override func startRefreshing() {
        ...
        lottieProvider.startRefreshing(refresh: self)
    }
    ...
    open override func pullingProgress(_ value: CGFloat) {
        ...
        lottieProvider.pullingProgress(refresh: self, progress: value)
    }
    ...
    open override func refreshing() {
        ...
        lottieProvider.refreshing(refresh: self)
    }
    ...
    open override func finishedRefreshing(isNoMoreData: Bool) {
        ...
        lottieProvider.finishedRefreshing(refresh: self, isNoMoreData: isNoMoreData)
    }
    ...
    open override func resetRefreshing() {
        ...
        lottieProvider.resetRefreshing(refresh: self)
    }
