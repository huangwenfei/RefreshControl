...
open class RefreshTextImagesFooter: RefreshFooter {
    ...
    open var indicatorProvider: RefreshImagesContentProvider = .init()
    ...
    // MARK: Indicator
    open func setIndicator(images: [UIImage], duration: TimeInterval, for state: OptionRefreshState) {
        indicatorProvider.set(images: images, duration: duration, for: state)
    }
    
    open func setIndicator(images: [UIImage], for state: OptionRefreshState) {
        indicatorProvider.set(images: images, for: state)
    }
